...
tuesdayMorningLimits = []
tuesdayEveningLimits = []
tuesdayNightLimits = []

wednesdayMorningLimits = []
wednesdayEveningLimits = []
wednesdayNightLimits = []

thursdayMorningLimits = []
thursdayEveningLimits = []
thursdayNightLimits = []
...
saturdayMorningLimits = []
saturdayEveningLimits = []
saturdayNightLimits = []
...
def sunday_protools(x):
    while len(SundayProtools) < x:
        ...
        sunday_protools.employee_amount = locals()
